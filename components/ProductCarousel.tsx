  ...
  return (
    <Carousel className="  w-full p-2 relative m-auto  bg-[#E5ADAF]">
      ...
      <CarouselContent className=" p-10 perspective-distant">       
        {Product.map((p, index) => (
          <CarouselItem key={index} className="md:basis-1/4 lg:basis-1/3 transform-3d rotate-x-21 rotate-z- shadow-xl transition-all duration-500 hover:-translate-y-8  hover:shadow-2xl">
            <div className="p-1">
              <Image
                src={p.img}
                width={1000}
